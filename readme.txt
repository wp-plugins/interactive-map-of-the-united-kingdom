...
Nice looking interactive HTML5 Map of the United Kingdom for WordPress with an option to customize the view and the behavior of the map.

== Description ==

Put an interactive high-quality HTML5 map of the United Kingdom to your WordPress powered blog!
...
Find other UK WordPress map plugins at [Fla-shop.com](http://www.fla-shop.com/country/uk/)
...
3. Map Preview page with tooltip
4. Map Preview page with additional content

== Frequently Asked Questions ==

= How can I insert a map to a page? = 
Insert the map short code `[freeukregionshtml5map id="0"]` into the text of a page or a post where you want the map to be.
